...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Press+Start+2P&size=14&duration=2500&pause=1000&color=FFD700&center=true&vCenter=true&width=600&lines=🎮+PRESS+START+TO+BEGIN;⭐+CGPA%3A+9.34+%2F+10.0;☁️+GCP+%2B+AWS+CERTIFIED;🍄+ALWAYS+LEVELLING+UP)](https://git.io/typing-svg)
...
## 🗺️ `< World 5 — Experience Map />`

```
╔════════════════════════════════════════════════════════════════════╗
║                                                                    ║
║  🎮  CODENEX          Associate Member        Nov 2024             ║
║  💻  ACM SIGKDD       Core Member             Apr 2025             ║
║  🔬  SRM UROP         AI Researcher           Aug 2025  🟢 ACTIVE  ║
║  🚀  Novacode         Frontend Dev Trainee    ✅ COMPLETED         ║
║  ☁️  Microsoft Elevate Cloud & AI Scholar     ✅ COMPLETED         ║
║  💰  JP Morgan        SWE Simulation          Dec 2025             ║
║  📈  McKinsey Forward Forward Program         Dec 2025             ║
║                                                                    ║
╚════════════════════════════════════════════════════════════════════╝
```
